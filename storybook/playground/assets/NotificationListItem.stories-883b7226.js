import{x as n}from"./lit-element-c5a2b594.js";import{l as i}from"./if-defined-c29cffe1.js";import{o}from"./unsafe-html-0ddd83da.js";import{V as w}from"./ValueState-a555c094.js";const x={wrappingType:{control:"select",options:["None","Normal"]},state:{control:"select",options:["None","Positive","Critical","Negative","Information"]},importance:{control:"select",options:["Standard","Important"]},avatar:{control:{type:"text"},table:{type:{summary:"Array<HTMLElement>"}}},menu:{control:{type:"text"},table:{type:{summary:"Array<HTMLElement>"}}},footnotes:{control:{type:"text"},table:{type:{summary:"Array<HTMLElement>"}}},default:{control:{type:"text"},table:{type:{summary:"Array<Node>"}}},close:{description:"Fired when the `Close` button is pressed.",control:{type:!1},table:{category:"events"},UI5CustomData:{parameters:[{type:{text:"HTMLElement"},name:"item",_ui5privacy:"public",description:"the closed item."}]}}},_={package:"@ui5/webcomponents-fiori",since:"1.0.0-rc.8",tagName:"ui5-li-notification"};var l=Object.freeze,$=Object.defineProperty,h=(e,y)=>l($(e,"raw",{value:l(y||e.slice())})),u,c;const L={title:"Fiori/Notification List Item",component:"NotificationListItem",parameters:{docs:{story:{iframeHeight:"470px",inline:!1}}},argTypes:x},s=e=>n(u||(u=h([`<ui5-list header-text="Notifications">
	`,`
</ui5-list>
...
}`,...(v=(g=t.parameters)==null?void 0:g.docs)==null?void 0:v.source}}};const D=["Basic","InShellBar"],P=Object.freeze(Object.defineProperty({__proto__:null,Basic:a,InShellBar:t,__namedExportsOrder:D,default:L},Symbol.toStringTag,{value:"Module"}));export{P as C,_ as c};
