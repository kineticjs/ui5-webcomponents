...
`,e.jsxs(n.p,{children:["Therefore, the ",e.jsx(n.code,{children:".hbs"})," file is there just for convenience, the end result will always be optimized lit-html."]}),`
...
`,e.jsxs(n.h3,{id:"bindings-",children:["Bindings ",e.jsx("a",{name:"syntax_bindings"})]}),`
...
`,e.jsxs(n.h3,{id:"conditions-",children:["Conditions ",e.jsx("a",{name:"syntax_conditional"})]}),`
...
{{/if}}
`})}),`
`,e.jsxs(n.h3,{id:"loops-",children:["Loops ",e.jsx("a",{name:"syntax_loops"})]}),`
...
`,e.jsxs(n.h3,{id:"property-assignment-the--prefix-",children:["Property assignment (the ",e.jsx(n.code,{children:"."})," prefix) ",e.jsx("a",{name:"syntax_dot"})]}),`
...
`,e.jsxs(n.h3,{id:"boolean-attribute-assignment-the--prefix-",children:["Boolean attribute assignment (the ",e.jsx(n.code,{children:"?"})," prefix) ",e.jsx("a",{name:"syntax_question_mark"})]}),`
...
`,e.jsxs(n.h3,{id:"event-handlers-assignment-the--prefix-",children:["Event handlers assignment (the ",e.jsx(n.code,{children:"@"})," prefix) ",e.jsx("a",{name:"syntax_at"})]}),`
...
`})}),`
`,e.jsxs(n.h3,{id:"style-maps-",children:["Style maps ",e.jsx("a",{name:"syntax_style_maps"})]}),`
...
`,e.jsxs(n.h3,{id:"class-maps-",children:["Class maps ",e.jsx("a",{name:"syntax_class_maps"})]}),`
...
`,e.jsxs(n.h3,{id:"partials-",children:["Partials ",e.jsx("a",{name:"syntax_partials"})]}),`
...
`,e.jsxs(n.h3,{id:"include-",children:["Include ",e.jsx("a",{name:"syntax_include"})]}),`
...
{{/inline}}
`})}),`
`,e.jsxs(n.p,{children:["Then the ",e.jsx(n.code,{children:"Demo2"})," component will use the ",e.jsx(n.code,{children:".hbs"})," file of the ",e.jsx(n.code,{children:"Demo"})," component, however with its own version of its partials."]}),`
`,e.jsxs(n.h2,{id:"5-using-the-slot-element-",children:["5. Using the ",e.jsx(n.code,{children:"slot"})," element ",e.jsx("a",{name:"slots"})]}),`
`,e.jsxs(n.h3,{id:"rendering-slots-",children:["Rendering slots ",e.jsx("a",{name:"slots_rendering"})]}),`
...
`,e.jsxs(n.h3,{id:"individual-slots-",children:["Individual slots ",e.jsx("a",{name:"slots_individual"})]}),`
...
`,e.jsx(a,{})]})}function b(s={}){const{wrapper:n}=Object.assign({},i(),s.components);return n?e.jsx(n,Object.assign({},s,{children:e.jsx(t,s)})):t(s)}export{b as default};
