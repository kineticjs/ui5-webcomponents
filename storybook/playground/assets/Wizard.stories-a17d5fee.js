...
or by clicking on the steps within the component header.`,control:{type:!1},table:{category:"events"},UI5CustomData:{parameters:[{type:{text:"WizardStep",references:[{name:"WizardStep",package:"@ui5/webcomponents-fiori",module:"dist/WizardStep.js"}]},name:"step",_ui5privacy:"public",description:"The new step."},{type:{text:"WizardStep",references:[{name:"WizardStep",package:"@ui5/webcomponents-fiori",module:"dist/WizardStep.js"}]},name:"previousStep",_ui5privacy:"public",description:"The previous step."},{type:{text:"boolean"},name:"withScroll",_ui5privacy:"public",description:"true when the event occurs due to user scrolling."}]}}},y={package:"@ui5/webcomponents-fiori",since:"1.0.0-rc.10",tagName:"ui5-wizard"};var l=Object.freeze,f=Object.defineProperty,x=(n,z)=>l(f(n,"raw",{value:l(z||n.slice())})),s,a;const g={title:"Fiori/Wizard",component:"Wizard",argTypes:v};let e=0;const i=()=>m(s||(s=x([`
	<ui5-wizard id="wiz-`,`">
...
\``,...(r=(d=i.parameters)==null?void 0:d.docs)==null?void 0:r.source}}};var o,p,c;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:`() => html\`
    ...
    <\/script>
\``,...(c=(p=t.parameters)==null?void 0:p.docs)==null?void 0:c.source}}};const w=["Basic","PageMode"],h=Object.freeze(Object.defineProperty({__proto__:null,Basic:i,PageMode:t,__namedExportsOrder:w,default:g},Symbol.toStringTag,{value:"Module"}));export{h as C,y as c};
