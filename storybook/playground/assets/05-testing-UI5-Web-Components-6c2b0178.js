...
`,e.jsxs(n.p,{children:["The browser of choice for test execution is ",e.jsx(n.a,{href:"https://www.google.com/chrome/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Google Chrome"}),", respectively the used WebDriver is ",e.jsx(n.a,{href:"https://chromedriver.chromium.org/",target:"_blank",rel:"nofollow noopener noreferrer",children:"ChromeDriver"}),"."]}),`
...
`,e.jsxs(n.h3,{id:"do-not-overuse-assertok",children:["Do not overuse ",e.jsx(n.code,{children:"assert.ok"})]}),`
...
`]}),`
`,e.jsxs(n.h3,{id:"do-not-overuse-assertstrictequal",children:["Do not overuse ",e.jsx(n.code,{children:"assert.strictEqual"})]}),`
...
`]}),`
`,e.jsxs(n.h3,{id:"use-isexisting-to-check-dom",children:["Use ",e.jsx(n.code,{children:"isExisting"})," to check DOM"]}),`
...
`})}),`
`,e.jsxs(n.h3,{id:"do-not-use-browserexecuteasync-for-properties",children:["Do not use ",e.jsx(n.code,{children:"browser.executeAsync"})," for properties"]}),`
...
`,e.jsxs(n.h3,{id:"use-assertinclude-instead-of-string-functions",children:["Use ",e.jsx(n.code,{children:"assert.include"})," instead of string functions"]}),`
`,e.jsx(n.p,{children:"Use:"}),`
...
`})}),`
`,e.jsx(n.h3,{id:"extract-variables-before-asserting",children:"Extract variables before asserting"}),`
...
`]}),`
`,e.jsx(n.h3,{id:"51-supporting-the-synchronous-syntax-for-writing-tests",children:"5.1 Supporting the synchronous syntax for writing tests"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["Change your ",e.jsx(n.code,{children:"config/wdio.conf.js"})," file's content from:"]}),`
`]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-js",children:`module.exports = require("@ui5/webcomponents-tools/components-package/wdio.js");
`})}),`
`,e.jsx(n.p,{children:"to:"}),`
