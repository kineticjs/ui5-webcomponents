...
`,e.jsxs(n.p,{children:["Since the event decorator is imported with the ",e.jsx(n.code,{children:"event"})," keyword"]}),`
`,e.jsx(n.p,{children:"Example:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-ts",children:`import event from "@ui5/webcomponents-base/dist/decorators/event.js";
`})}),`
...
`})}),`
`,e.jsx("br",{}),`
`,e.jsx(n.p,{children:e.jsxs(n.strong,{children:["2. When should we use the ",e.jsx(n.code,{children:'"!"'})," operator in a component file?"]})}),`
...
`,e.jsx(n.p,{children:"This operator can also be used in other situations where TypeScript does not understand the framework lifecycle, for example, when working with custom elements."}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-ts",children:`_getDialog() {
...
`})}),`
`,e.jsx(o,{})]})}function g(t={}){const{wrapper:n}=Object.assign({},i(),t.components);return n?e.jsx(n,Object.assign({},t,{children:e.jsx(s,t)})):s(t)}export{g as default};
