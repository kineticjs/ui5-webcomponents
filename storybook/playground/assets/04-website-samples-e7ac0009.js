...
`})}),`
`,e.jsx(n.p,{children:`However, in most cases you have the project built, so it would be faster
...
`,e.jsx(n.p,{children:'The title ("My New Sample") and the description ("The Button..") will be displayed at the top of the sample itself. Adding title and description is recommended -  they help viewers better understand what they are looking at.'}),`
...
`,e.jsx(n.p,{children:`All components have a sample called "Basic" used as the first sample displayed right-after the component's overview. Don't use "Basic" for other samples.`}),`
`,e.jsx(o,{})]})}function w(s={}){const{wrapper:n}=Object.assign({},i(),s.components);return n?e.jsx(n,Object.assign({},s,{children:e.jsx(t,s)})):t(s)}export{w as default};
