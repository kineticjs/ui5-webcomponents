...
`,e.jsx(o.p,{children:"A story is a documentation of a UI component that captures its rendered state in various scenarios. Stories are useful for documenting all potential states that a component can display, and they allow developers to test UI components in isolation."}),`
`,e.jsx(o.p,{children:"UI components can be rendered in various scenarios, for example with different props or state, or in different layouts or contexts. Stories capture these scenarios and provide documentation of the component's behavior in each scenario."}),`
...
`,e.jsx(o.p,{children:"The args object is used to define the properties of the component, users can edit in the playground. Decorators and parameters can enhance the documentation of stories."}),`
...
`]}),`
`,e.jsx(i,{})]})}function j(t={}){const{wrapper:o}=Object.assign({},r(),t.components);return o?e.jsx(o,Object.assign({},t,{children:e.jsx(n,t)})):n(t)}export{j as default};
