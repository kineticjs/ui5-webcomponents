...
`,e.jsx(t.p,{children:"The feature is useful when UI5 Web Components are used together with custom HTML elements with custom tags to make the application markup more semantic."}),`
...
`})}),`
`,e.jsxs(t.p,{children:["The ",e.jsx(t.code,{children:"ui5-card"})," is a UI5 Web Component, while the ",e.jsx(t.code,{children:"app-trip-calendar"})," is an app-defined custom HTML element with just a semantic purpose, no JavaScript attached. It is slotted in the content of the ",e.jsx(t.code,{children:"ui5-card"}),"."]}),`
...
In cases like this, we recommend using `,e.jsx(t.code,{children:"ignoreCustomElements"})," to let the UI5 Web Components framework treat such custom HTML elements as if they are standard HTML elements, such as: ",e.jsx(t.code,{children:"div"}),", ",e.jsx(t.code,{children:"span"}),", etc."]}),`
`,e.jsx(i,{})]})}function x(n={}){const{wrapper:t}=Object.assign({},r(),n.components);return t?e.jsx(t,Object.assign({},n,{children:e.jsx(s,n)})):s(n)}export{x as default};
