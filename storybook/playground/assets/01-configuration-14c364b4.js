import{j as e}from"./jsx-runtime-670e1be8.js";import{M as c}from"./index-d724c50e.js";import{F as d}from"./Footer-c6493654.js";import{u as t}from"./index-bd2d4f36.js";import"./index-4e9ba9b8.js";import"./_commonjsHelpers-725317a4.js";import"./iframe-3eded479.js";import"../sb-preview/runtime.js";import"./index-11d98b33.js";import"./index-d38538b0.js";import"./index-356e4a49.js";function s(i){const n=Object.assign({h1:"h1",p:"p",em:"em",h2:"h2",table:"table",thead:"thead",tr:"tr",th:"th",tbody:"tbody",td:"td",a:"a",code:"code",h3:"h3",ul:"ul",li:"li",pre:"pre",strong:"strong"},t(),i.components);return e.jsxs(e.Fragment,{children:[e.jsx(c,{title:"Docs/Advanced/Configuration"}),`
...
`,e.jsx("a",{name:"timezone"}),`
`,e.jsxs(n.p,{children:['The time zone should be an IANA time zone ID, e.g. "America/New_York". It can be set to the ',e.jsx(n.code,{children:"timezone"})," property in the configuration script."]}),`
`,e.jsx(n.p,{children:"Example:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-html",children:`<script data-ui5-config type="application/json">
{
...
`})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"timezone"})," - can only be set initially in the configuration script."]}),`
`]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-js",children:`import { getTimezone } from "@ui5/webcomponents-base/dist/config/Timezone.js";
`})}),`
`,e.jsx(d,{})]})}function f(i={}){const{wrapper:n}=Object.assign({},t(),i.components);return n?e.jsx(n,Object.assign({},i,{children:e.jsx(s,i)})):s(i)}export{f as default};
