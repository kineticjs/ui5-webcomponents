...
`,e.jsx(s.p,{children:"The theming of UI5 Web Components is based entirely on CSS variables. Switching between themes means changing the values of these CSS Variables. Applying a custom theme means setting custom values for these CSS Variables."}),`
...
`,e.jsx(s.h1,{id:"creating-custom-theme",children:"Creating Custom Theme"}),`
...
`})}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:["Install ",e.jsx(s.code,{children:"@sap-theming/theming-base-content"})," from NPM to get the source less files of the themes we are going to extend."]}),`
`]}),`
...
@sapPrimary2: violet;
`})}),`
`,e.jsx(s.h3,{id:"3-generating-the-custom-css-vars",children:"3. Generating the Custom CSS vars"}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:["Install ",e.jsx(s.code,{children:"less"})," to compile less to css."]}),`
`]}),`
...
`})}),`
`,e.jsxs(s.p,{children:["The script runs the less compiler over the less file (",e.jsx(s.code,{children:"src/mytheme.less"}),") to produce a css out of it (",e.jsx(s.code,{children:"dist/mytheme.css"}),`)
...
`,e.jsx(s.h1,{id:"using-custom-theme",children:"Using Custom Theme"}),`
...
`,e.jsx(r,{})]})}function b(n={}){const{wrapper:s}=Object.assign({},i(),n.components);return s?e.jsx(s,Object.assign({},n,{children:e.jsx(t,n)})):t(n)}export{b as default};
