...
`]}),`
`,e.jsxs(n.p,{children:["According to the WAI-ARIA recommendations, the live regions should be initialised empty when the page is loaded. This way screen readers remember them and start to listen for changes of their value. Thus, we recommend to instantiate Invisible Message as early as possible in the application. Then, you should specify the text that has to be announced by the screen reader and the live region mode using the ",e.jsx(n.code,{children:"announce"}),` method.
Here is an example usage of the invisible messaging service - `,e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/MessageStrip/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Dynamic MessageStrip Generator Sample"}),"."]}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["Popups: ",e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/components/Dialog/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Dialog"}),", ",e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/Popover/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Popover"})]}),`
`,e.jsxs(n.li,{children:["User input components (e.g. ",e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/Input/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Input"}),", ",e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/RadioButton/",target:"_blank",rel:"nofollow noopener noreferrer",children:"RadioButton"}),")"]}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/Panel/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Panel"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/Breadcrumbs/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Breadcrumbs"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/Button/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Button"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/Icon/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Icon"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/List/",target:"_blank",rel:"nofollow noopener noreferrer",children:"List"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/CheckBox/",target:"_blank",rel:"nofollow noopener noreferrer",children:"CheckBox"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/RatingIndicator/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Rating Indicator"})}),`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/Slider/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Slider"}),", ",e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/RangeSlider/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Range Slider"})]}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/compat/Table/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Table"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/Tree/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Tree"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/Card/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Card"})}),`
`]}),`
`,e.jsx(n.hr,{}),`
...
`,e.jsxs(n.li,{children:["Popups: ",e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/components/Dialog/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Dialog"}),", ",e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/Popover/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Popover"})]}),`
`,e.jsxs(n.li,{children:["User input components (e.g. ",e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/Input/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Input"}),", ",e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/RadioButton/",target:"_blank",rel:"nofollow noopener noreferrer",children:"RadioButton"}),")"]}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/Link/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Link"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/Button/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Button"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/List/",target:"_blank",rel:"nofollow noopener noreferrer",children:"List"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/CheckBox/",target:"_blank",rel:"nofollow noopener noreferrer",children:"CheckBox"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/compat/Table/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Table"})}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/fiori/FlexibleColumnLayout/",target:"_blank",rel:"nofollow noopener noreferrer",children:"FlexibleColumnLayout"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/fiori/ShellBar/",target:"_blank",rel:"nofollow noopener noreferrer",children:"ShellBar"})}),`
`]}),`
`,e.jsx(n.hr,{}),`
`,e.jsx(n.h3,{id:"accessibilityattributes",children:"accessibilityAttributes"}),`
`,e.jsxs(n.p,{children:["This property accepts an ",e.jsx(n.code,{children:"object"})," with property values, which will be used to generate additional accessibility attributes to the root element. For more detailed information on every object property, read the API description in ",e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/Button/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Button"}),"."]}),`
`,e.jsx(n.p,{children:"Setting the property on the custom element as:"}),`
...
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/List/",target:"_blank",rel:"nofollow noopener noreferrer",children:"List"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/Icon/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Icon"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/Popover/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Popover"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/Dialog/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Dialog"})}),`
`]}),`
`,e.jsx(n.hr,{}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/Title/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Title"})}),`
`]}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/Avatar/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Avatar"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://sap.github.io/ui5-webcomponents/nightly/components/Icon/",target:"_blank",rel:"nofollow noopener noreferrer",children:"Icon"})}),`
`]}),`
`,e.jsx(n.hr,{}),`
...
`,e.jsx(n.p,{children:"When reporting issues with different testing environments, please ensure that the issue is not false positive, a real accessibility concern is present, and there is an impact on the users. Therefore, we recommend to retest the issue using the mentioned reference testing tools and additionally with plain HTML."}),`
`,e.jsx(n.p,{children:"In order to process the issues correctly, we would like to have the following information provided:"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Issue description"}),`
`,e.jsx(n.li,{children:"Reference to the suspected violated accessibility requirement (e.g. Web Content Accessibility Guidelines, WCAG 2.0, BITV 2.0, EN 301 549)"}),`
`,e.jsx(n.li,{children:"Isolated example"}),`
`,e.jsx(n.li,{children:"Steps to reproduce"}),`
`,e.jsx(n.li,{children:"UI5 Web Components version"}),`
`,e.jsx(n.li,{children:"OS/Platform: {...}"}),`
`,e.jsx(n.li,{children:"Browser: {...}"}),`
`,e.jsx(n.li,{children:"Testing Tool"}),`
`]}),`
...
`,e.jsx(s,{})]})}function g(t={}){const{wrapper:n}=Object.assign({},o(),t.components);return n?e.jsx(n,Object.assign({},t,{children:e.jsx(i,t)})):i(t)}export{g as default};
