...
let FlexibleColumnLayout = FlexibleColumnLayout_1 = class FlexibleColumnLayout extends UI5Element {
    ...
    setCustomColumnLayout(layout, columnLayout) {
        if (this.mediaAllowsCustomConfiguration(this.media)) {
    ...
    normalizeColumnWidths(columnLayout) {
    ...
    adjustWidthsToMinWidth(pxWidths) {
    ...
    getIndicesOfColumnsBelowMinWidth(columnLayout) {
        const indices = [];
    ...
    getIndexOfWidestColumn(columnLayout) {
        let maxIndex = 0;
        columnLayout.forEach((pxWidth, i) => {
